...
export default function Page() {
  return (
    <main className='flex min-h-screen flex-col p-6'>
      ...
      <div className='mt-4 flex grow flex-col gap-4 md:flex-row md:flex-wrap lg:flex-nowrap'>
        <div className='flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-full lg:w-2/5 md:px-20'>
        ...
        <div className='flex items-center justify-center p-6 md:w-full lg:w-3/5 md:px-28 md:py-12'>
